...
class TestProto final :
 ...
 public:
  ...
  ~TestProto() override;
  explicit PROTOBUF_CONSTEXPR TestProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TestProto2 final :
 ...
 public:
  ...
  ~TestProto2() override;
  explicit PROTOBUF_CONSTEXPR TestProto2(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const TestProto2& from) {
    TestProto2::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline void TestProto::set_has_string_oneof() {
  _impl_._oneof_case_[0] = kStringOneof;
}
...
inline void TestProto::set_string_oneof(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_string_oneof()) {
    ...
    _impl_.one_of_field_.string_oneof_.InitDefault();
  }
  _impl_.one_of_field_.string_oneof_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& TestProto::_internal_string_oneof() const {
  if (_internal_has_string_oneof()) {
    return _impl_.one_of_field_.string_oneof_.Get();
  }
...
inline void TestProto::_internal_set_string_oneof(const std::string& value) {
  ...
  _impl_.one_of_field_.string_oneof_.Set(value, GetArenaForAllocation());
}
inline std::string* TestProto::_internal_mutable_string_oneof() {
  ...
  return _impl_.one_of_field_.string_oneof_.Mutable(      GetArenaForAllocation());
}
inline std::string* TestProto::release_string_oneof() {
  ...
  if (_internal_has_string_oneof()) {
    clear_has_one_of_field();
    return _impl_.one_of_field_.string_oneof_.Release();
  } else {
    return nullptr;
  }
}
inline void TestProto::set_allocated_string_oneof(std::string* string_oneof) {
  ...
  if (string_oneof != nullptr) {
    set_has_string_oneof();
    _impl_.one_of_field_.string_oneof_.InitAllocated(string_oneof, GetArenaForAllocation());
  }
...
inline void TestProto::_internal_set_bool_oneof(bool value) {
  ...
  _impl_.one_of_field_.bool_oneof_ = value;
}
...
inline void TestProto::set_has_message_oneof() {
  _impl_._oneof_case_[0] = kMessageOneof;
}
...
inline ::clarifai::api::utils::TestProto2* TestProto::release_message_oneof() {
  ...
  if (_internal_has_message_oneof()) {
    clear_has_one_of_field();
    ::clarifai::api::utils::TestProto2* temp = _impl_.one_of_field_.message_oneof_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.one_of_field_.message_oneof_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::clarifai::api::utils::TestProto2* TestProto::_internal_mutable_message_oneof() {
  if (!_internal_has_message_oneof()) {
    clear_one_of_field();
    set_has_message_oneof();
    _impl_.one_of_field_.message_oneof_ = CreateMaybeMessage< ::clarifai::api::utils::TestProto2 >(GetArenaForAllocation());
  }
  return _impl_.one_of_field_.message_oneof_;
}
...
inline TestProto::OneOfFieldCase TestProto::one_of_field_case() const {
  return TestProto::OneOfFieldCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
