...
class Status final :
 ...
 public:
  ...
  void clear_developer_notes();
  const std::string& developer_notes() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_developer_notes(ArgT0&& arg0, ArgT... args);
  std::string* mutable_developer_notes();
  PROTOBUF_NODISCARD std::string* release_developer_notes();
  void set_allocated_developer_notes(std::string* developer_notes);
  private:
  const std::string& _internal_developer_notes() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_developer_notes(const std::string& value);
  std::string* _internal_mutable_developer_notes();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr developer_notes_;
...
// string developer_notes = 10;
inline void Status::clear_developer_notes() {
  _impl_.developer_notes_.ClearToEmpty();
}
inline const std::string& Status::developer_notes() const {
  // @@protoc_insertion_point(field_get:clarifai.api.status.Status.developer_notes)
  return _internal_developer_notes();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Status::set_developer_notes(ArgT0&& arg0, ArgT... args) {
 
 _impl_.developer_notes_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:clarifai.api.status.Status.developer_notes)
}
inline std::string* Status::mutable_developer_notes() {
  std::string* _s = _internal_mutable_developer_notes();
  // @@protoc_insertion_point(field_mutable:clarifai.api.status.Status.developer_notes)
  return _s;
}
inline const std::string& Status::_internal_developer_notes() const {
  return _impl_.developer_notes_.Get();
}
inline void Status::_internal_set_developer_notes(const std::string& value) {
  
  _impl_.developer_notes_.Set(value, GetArenaForAllocation());
}
inline std::string* Status::_internal_mutable_developer_notes() {
  
  return _impl_.developer_notes_.Mutable(GetArenaForAllocation());
}
inline std::string* Status::release_developer_notes() {
  // @@protoc_insertion_point(field_release:clarifai.api.status.Status.developer_notes)
  return _impl_.developer_notes_.Release();
}
inline void Status::set_allocated_developer_notes(std::string* developer_notes) {
  if (developer_notes != nullptr) {
    
  } else {
    
  }
  _impl_.developer_notes_.SetAllocated(developer_notes, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.developer_notes_.IsDefault()) {
    _impl_.developer_notes_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:clarifai.api.status.Status.developer_notes)
}
