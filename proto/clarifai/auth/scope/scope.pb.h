...
constexpr S S_MAX = ModelExports_Add;
...
class ScopeList final :
 ...
 public:
  ...
  ~ScopeList() override;
  explicit PROTOBUF_CONSTEXPR ScopeList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline ::clarifai::auth::scope::S ScopeList::_internal_scopes(int index) const {
  return static_cast< ::clarifai::auth::scope::S >(_impl_.scopes_.Get(index));
}
...
inline void ScopeList::set_scopes(int index, ::clarifai::auth::scope::S value) {
  _impl_.scopes_.Set(index, value);
